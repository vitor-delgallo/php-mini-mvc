...
| Globals | `System\Config\Globals` | `globals_get`, `globals_add`, `globals_merge`, `globals_forget`, `globals_reset`, `globals_env`, API request helpers | [04-system-config-globals.md](helpers/04-system-config-globals.md) |
...
| Language | `System\Core\Language` | `language_get`, `lg`, `language_load`, `ld`, `language_detect`, `language_current`, `language_default` | [07-system-core-language.md](helpers/07-system-core-language.md) |
...
| --- | --- | --- |
| PHP autoload | `System\Core\PHPAutoload` | [12-system-core-phpautoload.md](helpers/12-system-core-phpautoload.md) |
| Router loader | `System\Core\RouterLoader` | [13-system-core-routerloader.md](helpers/13-system-core-routerloader.md) |
